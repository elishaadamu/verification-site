      ...
      <main style={{ flexGrow: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "3rem 1.5rem" }}>
        ...
        >
          ...
          <p style={{ fontSize: "0.95rem", color: "var(--text-secondary)", marginBottom: "2rem", lineHeight: 1.6 }}>
            Official identity amendment and clearance requests are processed securely inside the <strong>Applicant Portal Dashboard</strong>.
          </p>
          ...
          >
            <span>Open Manual Registration</span>
            <ArrowRight size={18} />
          </Link>
        </div>
      </main>
